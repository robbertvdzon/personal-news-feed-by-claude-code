...
- Tech-events ontdekt en bijhoudt (Tavily + Claude)
...
### Events
- Gebruiker ziet een lijst van aankomende en afgelopen tech-events ontdekt via Tavily + Claude.
...
### Settings
- Gebruiker beheert categorie-instellingen, RSS-feeds en event-voorkeuren.
- Gebruiker kan een event van de denylist halen via de Settings-UI (naam-snapshot beschikbaar).
...
- [x] De discovery pipeline doet geen Tavily/Claude-calls voor events op de denylist.
