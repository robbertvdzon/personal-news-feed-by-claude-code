...
## Scope
- Breng in kaart welke functionele scenario's de code ondersteunt (incl. de `e2e`-suite).
- Signaleer ontbrekende of verouderde integratie-/e2e-testscenario's (geen tests zelf
  toevoegen — dat hoort in de voorgestelde vervolg-story).
