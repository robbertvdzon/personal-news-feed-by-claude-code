...
class AuthServiceImplRegisterTest {
    ...
    fun setUp() {
        ...
        val googleVerifier = mock(GoogleIdTokenVerifier::class.java)
        val googleLoginConfig = mock(GoogleLoginConfig::class.java)
        service = AuthServiceImpl(users, jwt, events, googleVerifier, googleLoginConfig)
    }
