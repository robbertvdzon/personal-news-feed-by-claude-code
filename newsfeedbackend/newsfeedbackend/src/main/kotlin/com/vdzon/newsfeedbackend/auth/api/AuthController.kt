...
import com.vdzon.newsfeedbackend.auth.api.dto.GoogleAuthRequest
...
class AuthController(
    ...
    @PostMapping("/google")
    fun google(@RequestBody body: GoogleAuthRequest): ResponseEntity<AuthResponse> {
        val token = authService.loginWithGoogle(body.idToken)
    ...
    private fun requirePasswordAuth() {
        if (!googleLoginConfig.passwordAuthEnabled) {
