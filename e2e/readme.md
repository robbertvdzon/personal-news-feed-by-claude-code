...
3. Voer de scenario's in deze volgorde uit:
   1. `start-scenario.md`
   2. één of meer scenario's (`rss-scenario.md`, `feed-scenario.md`, `samenvatting-scenario.md`, `podcast-scenario.md`, `rss-podcast-scenario.md`, `settings-scenario.md`, `api-log-scenario.md`, `admin-scenario.md`)
