...
- `grep -rn "BadRequestException(" newsfeedbackend/newsfeedbackend/src/main` = 13 regels (12 throw-sites + de klassedeclaratie) tegenover `grep -c "'400'" specs/openapi.yaml` = 10 (nagelopen in SF-2179).
